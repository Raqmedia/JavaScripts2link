...
window.EnglezzQuizLoader = {
           ...
           <div class="max-w-4xl mx-auto px-4 py-8">
            ...
            <div class="englezzreadingquiz-card p-6 md:p-8 mb-6">
             <div class="bg-gradient-to-br from-orange-50 to-amber-50 p-6 rounded-xl border-l-4 border-orange-400">
              ...
              <p class="text-sm text-gray-500 mb-4 italic">Passage length varies by difficulty: Easy (300 words) | Medium (450 words) | Hard (700 words)</p>
         ...
         <div class="englezzreadingquiz-card p-6 md:p-8">
          <div id="englezzreadingquiz-difficulty-screen">
           ...
           <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <button onclick="EnglezzQuizLoader.selectDifficulty('easy')" class="englezzreadingquiz-difficulty-btn englezzreadingquiz-btn englezzreadingquiz-ripple bg-gradient-to-br from-green-400 to-green-600 text-white p-6 rounded-xl" id="englezzreadingquiz-easy-btn"><div class="text-4xl mb-3">🌱</div><div class="font-bold text-xl mb-2">Easy</div></button>
            <button onclick="EnglezzQuizLoader.selectDifficulty('medium')" class="englezzreadingquiz-difficulty-btn englezzreadingquiz-btn englezzreadingquiz-ripple bg-gradient-to-br from-amber-400 to-orange-500 text-white p-6 rounded-xl" id="englezzreadingquiz-medium-btn"><div class="text-4xl mb-3">🔥</div><div class="font-bold text-xl mb-2">Medium</div></button>
            <button onclick="EnglezzQuizLoader.selectDifficulty('hard')" class="englezzreadingquiz-difficulty-btn englezzreadingquiz-btn englezzreadingquiz-ripple bg-gradient-to-br from-red-500 to-rose-600 text-white p-6 rounded-xl" id="englezzreadingquiz-hard-btn"><div class="text-4xl mb-3">💎</div><div class="font-bold text-xl mb-2">Hard</div></button>
           </div>
           <button id="englezzreadingquiz-start-btn" onclick="EnglezzQuizLoader.startQuiz()" class="englezzreadingquiz-btn englezzreadingquiz-ripple w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold py-4 px-8 rounded-xl text-lg disabled:opacity-50 disabled:cursor-not-allowed"> Start Quiz 📚 </button>
          </div>
    ...
    renderActivity1: function() {
        ...
        container.innerHTML = `<h3 class="englezzreadingquiz-title text-2xl font-bold text-gray-800 mb-4">✍️ Activity 1: Written Answers</h3><div id="englezzreadingquiz-activity1-questions"></div><div class="mt-6 text-center"><button onclick="EnglezzQuizLoader.progressToActivity()" class="englezzreadingquiz-btn englezzreadingquiz-ripple bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold py-3 px-8 rounded-xl"> Continue → </button></div>`;
        ...
        qContainer.innerHTML = this.currentQuestions.activity1.map((q, index) => `
            <div class="mb-6 p-5 bg-gray-50 rounded-xl border-2 border-gray-200">
              ...
              <button onclick="EnglezzQuizLoader.checkActivity1(${q.id})" class="englezzreadingquiz-btn englezzreadingquiz-ripple mt-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold py-2 px-6 rounded-lg">Check Answer</button>
    ...
    renderActivity2: function() {
        ...
        container.innerHTML = `<h3 class="englezzreadingquiz-title text-2xl font-bold text-gray-800 mb-4">✓✗ Activity 2: True or False</h3><div id="englezzreadingquiz-activity2-questions"></div><div class="mt-6 text-center"><button onclick="EnglezzQuizLoader.progressToActivity()" class="englezzreadingquiz-btn englezzreadingquiz-ripple bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold py-3 px-8 rounded-xl"> Continue → </button></div>`;
        ...
        qContainer.innerHTML = this.currentQuestions.activity2.map((q, index) => `
            <div class="mb-4 p-5 bg-gray-50 rounded-xl border-2 border-gray-200">
              ...
              <div class="flex gap-3">
                <button onclick="EnglezzQuizLoader.selectTF(${q.id}, true)" class="englezzreadingquiz-option englezzreadingquiz-ripple flex-1 py-3 px-6 border-2 border-gray-300 rounded-xl font-semibold bg-white hover:bg-green-50" id="englezzreadingquiz-a2-true-${q.id}">✓ True</button>
                <button onclick="EnglezzQuizLoader.selectTF(${q.id}, false)" class="englezzreadingquiz-option englezzreadingquiz-ripple flex-1 py-3 px-6 border-2 border-gray-300 rounded-xl font-semibold bg-white hover:bg-red-50" id="englezzreadingquiz-a2-false-${q.id}">✗ False</button>
              </div>
    ...
    renderActivity3: function() {
        ...
        container.innerHTML = `<h3 class="englezzreadingquiz-title text-2xl font-bold text-gray-800 mb-4">🔘 Activity 3: Multiple Choice</h3><div id="englezzreadingquiz-activity3-questions"></div><div class="mt-6 text-center"><button onclick="EnglezzQuizLoader.progressToActivity()" class="englezzreadingquiz-btn englezzreadingquiz-ripple bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold py-3 px-8 rounded-xl"> Continue → </button></div>`;
            ...
            <div class="mb-6 p-5 bg-gray-50 rounded-xl border-2 border-gray-200">
              ...
              <div class="space-y-2">
                ${q.options.map((opt, optIndex) => `
                  <button onclick="EnglezzQuizLoader.selectMCQ(${q.id}, ${optIndex})" class="englezzreadingquiz-option englezzreadingquiz-ripple w-full text-left py-3 px-4 border-2 border-gray-300 rounded-xl bg-white" id="englezzreadingquiz-a3-opt-${q.id}-${optIndex}">
    ...
    renderActivity4: function() {
        ...
        container.innerHTML = `<h3 class="englezzreadingquiz-title text-2xl font-bold text-gray-800 mb-4">📝 Activity 4: Fill in Blanks</h3><div id="englezzreadingquiz-activity4-questions"></div><div class="mt-6 text-center"><button onclick="EnglezzQuizLoader.viewResults()" class="englezzreadingquiz-btn englezzreadingquiz-ripple bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold py-3 px-8 rounded-xl"> View Results 🏆 </button></div>`;
        ...
        qContainer.innerHTML = this.currentQuestions.activity4.map((q, index) => `
            <div class="mb-6 p-5 bg-gray-50 rounded-xl border-2 border-gray-200">
              ...
              <select id="englezzreadingquiz-a4-q${q.id}" class="englezzreadingquiz-textarea w-full p-3 border-2 border-gray-300 rounded-xl focus:outline-none bg-white" onchange="EnglezzQuizLoader.updateAnswer('activity4', ${q.id}, this.value)">
                <option value="">-- Select an answer --</option>
                ${q.options.map(opt => `<option value="${opt}">${opt}</option>`).join('')}
              </select>
              <button onclick="EnglezzQuizLoader.checkActivity4(${q.id})" class="englezzreadingquiz-btn englezzreadingquiz-ripple mt-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold py-2 px-6 rounded-lg">Check</button>
        ...
        resScreen.innerHTML = `
          <div class="text-center">
              ...
              <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <button onclick="EnglezzQuizLoader.retry()" class="englezzreadingquiz-btn bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold py-4 px-8 rounded-xl text-lg"> Try Again 🔄 </button>
                <button onclick="EnglezzQuizLoader.restart()" class="englezzreadingquiz-btn bg-gradient-to-r from-gray-500 to-gray-600 text-white font-bold py-4 px-8 rounded-xl text-lg"> Reset Menu 🏠 </button>
              </div>
          </div>`;
